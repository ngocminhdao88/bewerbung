...
%\social[github]{jdoe}
%\extrainfo{Geboren am 24.03.1988 in Hai Duong, Vietnam \makeheaddetailssymbol Verfügbarkeit: sofort}
%\extrainfo{Geboren am 24.03.1988 in Hai Duong, Vietnam}
...
%\fancyfoot[RE,LO]{\parbox[b]{21cm}{\color{color2}\addressfont\strut Ngoc Minh Dao~~\emailsymbol\emaillink{ngocminhdao88@gmail.com}~~\faMobile~{+49 17674561589}~~}}
\rfoot{Page \thepage}
...
\makecvtitle % Lebenslauf Title


% Persönliche Daten {{{
\section{\textbf{Persönliche Daten}}
\cvitemwithcomment{Name}{Ngoc Minh Dao}{}
\cvitemwithcomment{Adresse}{Bömelburgstraße 18B, 30165 Hannover}{}
\cvitemwithcomment{Mobil}{017674561589}{}
\cvitemwithcomment{E-Mail}{\href{mailto:ngocminhdao88@gmail.com}{ngocminhdao88@gmail.com}}{}
\cvitemwithcomment{Geburtsdatum/-ort}{24.03.1988 in Hai Duong, Vietnam}{}
\cvitemwithcomment{Staatsangehörigkeit}{vietnamesisch}{}

% Bewerbungsfoto
%\begin{picture}(0,0)
%    \put(345, 15){\includegraphics[scale=0.2]{./bilde/bewerbungsfoto_small.jpg}}
%\end{picture}
% }}}
...
{}
{
    \labelitemi\ Bachelorarbeit: ``Konstruktion und Fertigung von Werkzeughaltern und deren speziellen Einsätze''
}
%}}}
...
\cventry{05.2018--vsl. 09.2018}
{\labelitemi\ Finite-Elemente-Analyse und numerische Strömungsmechanik mit ANSYS}
...
\cventry{06.2018--vsl. 09.2018}
{\labelitemi\ Initialisierung, Planung, Ausführung von Projekten}
...
\cventry{07.2017}
{
\parbox[t]{10cm}{\labelitemi\ Allgemeiner Überblick von Fahrzeuggetrieben und Vertiefung durch Praxisbeispiele}
}
{Automatikgetriebe Schulung}
{Schaeffler Technologies AG \& Co. KG}
{}
...
\cventry{11.2016}
{\labelitemi\ Von digitalen Ideen bis zur Herstellung von Produkten}
{PTC Creo Training}
...
\cventry{07.2016}
{\labelitemi\ Dreitätiges Instructor-led-Training mit verschiedenen Themen und Modellierungstechniken}
{Autodesk Inventor Professional Workshop}
{ITA - LUH}
{}
{}
...
\cventry{01.2016}
{\labelitemi\ Rechnerische und algorithmische Denkweise zur Problemlösung}
...
\cventry{03.2017--09.2017}
{\labelitemi\ Laufen mit Schaeffler-Arbeitskollegen}
{Lauftreff}
{Herzogenaurach, Deutschland}
{}
{}
...
{\labelitemi\ Treffen und Diskutieren über elektronische Projekte}
{Arduino Hannover}
{Hannover, Deutschland}
{}
{}
...
{\labelitemi\ \parbox[t]{12cm}{KFZ Inspektion, Ölwechsel, Zerlegung und Montage von Motoren und Getrieben}}
...
% Badminton sport
\cventry{seit 2013}
{\labelitemi\ \parbox[t]{10cm}{Mannschaftsmitglied in der 1.Kreisliga des niedersächsischen Badminton-Verbands}}
{Badminton}
{Hannover, Deutschland}
{}
{}
...
\cvitemwithcomment{Vietnamesisch}{Muttersprache}{}
% }}}
